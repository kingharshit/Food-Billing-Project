...
root.configure(background='#B47EDE')

Tops = Frame(root,bg='#D7BFDC',bd=20,pady=5,relief=RIDGE)
Tops.pack(side=TOP)
...
lblTitle=Label(Tops, textvariable=Date1,font=('arial',24,'bold') ,pady=9,
                       bd=5,bg="#D7BFDC",fg="black").grid(row=0,column=0)


        
lblTitle=Label(Tops, textvariable=Time1, font=('arial',24,'bold') ,pady=9,
                       bd=5,bg="#D7BFDC",fg="black").grid(row=0,column=2)



lblTitle=Label(Tops,font=('arial',60,'bold'),text='FOOD ORDERING SYSTEM',bd=21,bg='#D7BFDC',
                fg='black',justify=CENTER)
lblTitle.grid(row=0)



ReceiptCal_F = Frame(root,bg='#D7BFDC',bd=10,relief=RIDGE)
ReceiptCal_F.pack(side=RIGHT)

Buttons_F=Frame(ReceiptCal_F,bg='#D7BFDC',bd=3,relief=RIDGE)
Buttons_F.pack(side=BOTTOM)

Cal_F=Frame(ReceiptCal_F,bg='#D7BFDC',bd=6,relief=RIDGE)
Cal_F.pack(side=TOP)

Receipt_F=Frame(ReceiptCal_F,bg='#D7BFDC',bd=4,relief=RIDGE)
Receipt_F.pack(side=BOTTOM)

MenuFrame = Frame(root,bg='#D7BFDC',bd=10,relief=RIDGE)
MenuFrame.pack(side=LEFT)
Cost_F=Frame(MenuFrame,bg='#D7BFDC',bd=4)
Cost_F.pack(side=BOTTOM)
Drinks_F=Frame(MenuFrame,bg='#D7BFDC',bd=4)
Drinks_F.pack(side=TOP)


Drinks_F=Frame(MenuFrame,bg='#D7BFDC',bd=4,relief=RIDGE)
Drinks_F.pack(side=LEFT)
Food_F=Frame(MenuFrame,bg='#D7BFDC',bd=4,relief=RIDGE)
...
def iExit():
    iExit=tkinter.messagebox.askyesno("Exit Food Odering System","Confirm if you want to exit")
    if iExit > 0:
        root.destroy()
        return
...
HotDog = Checkbutton(Food_F,text="HotDog\t\t\t ",variable=var9,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='#D7BFDC',command=chk_HotDog).grid(row=0,sticky=W)
VegBurger = Checkbutton(Food_F,text="VegBurger",variable=var10,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='#D7BFDC',command=chk_VegBurger).grid(row=1,sticky=W)
Pasta = Checkbutton(Food_F,text="Pasta ",variable=var11,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='#D7BFDC',command=chk_Pasta).grid(row=2,sticky=W)
HamBurger = Checkbutton(Food_F,text="Rice Plate ",variable=var12,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='#D7BFDC',command=chk_HamBurger).grid(row=3,sticky=W)
Sandwich = Checkbutton(Food_F,text="Sandwich ",variable=var13,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='#D7BFDC',command=chk_Sandwich).grid(row=4,sticky=W)
Fires = Checkbutton(Food_F,text="Fires ",variable=var14,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='#D7BFDC',command=chk_Fires).grid(row=5,sticky=W)
Spagetti = Checkbutton(Food_F,text="Spagetti ",variable=var15,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='#D7BFDC',command=chk_Spagetti).grid(row=6,sticky=W)
Fazitas = Checkbutton(Food_F,text="Fazitas ",variable=var16,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='#D7BFDC',command=chk_Fazitas).grid(row=7,sticky=W)
################################################Entry Box For Cake##########################################################
...
###########################################ToTal Cost################################################################################
lblCostofDrinks=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Drinks\t',bg='#D7BFDC',
                fg='black',justify=CENTER)
...
lblCostofFood=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Foods  ',bg='#D7BFDC',
                fg='black',justify=CENTER)
...
lblServiceCharge=Label(Cost_F,font=('arial',14,'bold'),text='Service Charge',bg='#D7BFDC',
                fg='black',justify=CENTER)
...
lblPaidTax=Label(Cost_F,font=('arial',14,'bold'),text='\tPaid Tax',bg='#D7BFDC',bd=7,
                fg='black',justify=CENTER)
...
lblSubTotal=Label(Cost_F,font=('arial',14,'bold'),text='\tSub Total',bg='#D7BFDC',bd=7,
                fg='black',justify=CENTER)
...
lblTotalCost=Label(Cost_F,font=('arial',14,'bold'),text='\tTotal',bg='#D7BFDC',bd=7,
                fg='black',justify=CENTER)
